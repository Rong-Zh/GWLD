...
#' @examples
#' g0 <- c(
#'   "T/A", NA, "T|T", NA, "T|A", NA, "T|T", "T/A", "T/T", "T/T",
#'   "T/A", "A|A", "T/T", "T|A", "T/A", "T|T", NA, "T|A", "T/A", NA
#' )
#'
#' g1 <- c(
#'   "C/A", "C/A", "C/C", "C/A", "C/C", "C/A", "C/A", "C/A",
...
#' MI(g4, cores = 2)
#' @rdname MI
setGeneric("MI", function(g1, g2, cores = 1, ...) {
  standardGeneric("MI")
})

#' @rdname MI
setMethod(
  "MI", signature(g1 = "data.frame"),
  function(g1, cores = 1) {
...
#' @rdname MI
setMethod(
  "MI", signature(g1 = "numeric", g2 = "numeric"),
  function(g1, g2) {
