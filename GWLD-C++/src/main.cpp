...
int main(int argc, char *argv[])
{
    ...
    string outprefix = a.get<string>("out-prefix"); // 输出文件名前缀
    arma::Mat<int> geno012;
    vector<vector<string>> snpinfo;
    if (a.exist("bfile"))
    { // 读取plink .bed, .fim, .bim文件
        ...
        if (a.exist("2vcf") || a.exist("allele-freq"))
        {
            if (a.exist("code012"))
            {
    ...
    if (a.exist("method"))
    {
        ...
        int thread = a.get<int>("threads"); // 线程数
