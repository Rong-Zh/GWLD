...
RcppExport SEXP _GGLD_stats_freq(SEXP vectorSEXP, SEXP sepSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _GGLD_recode(SEXP vectorSEXP, SEXP sepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< CharacterVector& >::type vector(vectorSEXP);
...
RcppExport SEXP _GGLD_code_Mat(SEXP MatrixSEXP, SEXP sepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _GGLD_read_bed(SEXP bedfileSEXP, SEXP nSampleSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _GGLD_RMIC(SEXP g1SEXP, SEXP g2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _GGLD_RMIC_Mat(SEXP geno012SEXP, SEXP coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _GGLD_MIC(SEXP g1SEXP, SEXP g2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Col<int>& >::type g1(g1SEXP);
...
RcppExport SEXP _GGLD_MIC_Mat(SEXP geno012SEXP, SEXP coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Mat<int>& >::type geno012(geno012SEXP);
...
RcppExport SEXP _GGLD_LDC(SEXP g1SEXP, SEXP g2SEXP, SEXP methodSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Col<int>& >::type g1(g1SEXP);
...
RcppExport SEXP _GGLD_LDC_Mat(SEXP geno012SEXP, SEXP methodSEXP, SEXP coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Mat<int>& >::type geno012(geno012SEXP);
...
RcppExport SEXP _GGLD_gwld(SEXP geno012SEXP, SEXP methodSEXP, SEXP threadSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Mat<int>& >::type geno012(geno012SEXP);
...
RcppExport SEXP _GGLD_decay(SEXP mSEXP, SEXP snpinfoSEXP, SEXP maxdistSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _GGLD_calc_decay(SEXP geno012SEXP, SEXP snpinfoSEXP, SEXP methodSEXP, SEXP threadSEXP, SEXP maxdistSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Mat<int>& >::type geno012(geno012SEXP);
...
RcppExport SEXP _GGLD_calc_circos(SEXP geno012SEXP, SEXP snpinfoSEXP, SEXP methodSEXP, SEXP threadSEXP, SEXP thresholdSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Mat<int>& >::type geno012(geno012SEXP);
...
RcppExport SEXP _GGLD_circos(SEXP mSEXP, SEXP snpinfoSEXP, SEXP thresholdSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::Mat<double>& >::type m(mSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_GGLD_stats_freq", (DL_FUNC) &_GGLD_stats_freq, 2},
    {"_GGLD_recode", (DL_FUNC) &_GGLD_recode, 2},
    {"_GGLD_code_Mat", (DL_FUNC) &_GGLD_code_Mat, 2},
    {"_GGLD_read_bed", (DL_FUNC) &_GGLD_read_bed, 2},
    {"_GGLD_RMIC", (DL_FUNC) &_GGLD_RMIC, 2},
    {"_GGLD_RMIC_Mat", (DL_FUNC) &_GGLD_RMIC_Mat, 2},
    {"_GGLD_MIC", (DL_FUNC) &_GGLD_MIC, 2},
    {"_GGLD_MIC_Mat", (DL_FUNC) &_GGLD_MIC_Mat, 2},
    {"_GGLD_LDC", (DL_FUNC) &_GGLD_LDC, 3},
    {"_GGLD_LDC_Mat", (DL_FUNC) &_GGLD_LDC_Mat, 3},
    {"_GGLD_gwld", (DL_FUNC) &_GGLD_gwld, 3},
    {"_GGLD_decay", (DL_FUNC) &_GGLD_decay, 3},
    {"_GGLD_calc_decay", (DL_FUNC) &_GGLD_calc_decay, 5},
    {"_GGLD_calc_circos", (DL_FUNC) &_GGLD_calc_circos, 5},
    {"_GGLD_circos", (DL_FUNC) &_GGLD_circos, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_GGLD(DllInfo *dll) {
